...
if($_SESSION["errorCounter"] == 0) 
{
	...
	$sql = "INSERT INTO tblPeople (alias, strFirstName, strLastName, strEmail, strPhone, isAdmin, isSupport, isWriter, isSource) VALUES ('" . $_SESSION["aliasAdd"] . "', '" . $_SESSION["firstNameAdd"] . "', '" . $_SESSION["lastNameAdd"] . "', '" . $_SESSION["emailAdd"] . "', '" . $_SESSION["phoneAdd"] . "', " . $_SESSION["isAdminAdd"]  . ", " . $_SESSION["isSupportAdd"]  . ", " . $_SESSION["isWriterAdd"]  . ");";
	$sql = "UPDATE tblPeople SET strFirstName='" . $_SESSION["firstNameAdd"] . "', strLastName='" . $_SESSION["lastNameAdd"] . "', alias='" . $_SESSION["aliasAdd"] . "', strPhone='" . $_SESSION["phoneAdd"] . "', strEmail='" . $_SESSION["emailAdd"] . "', isWriter=" . $_SESSION["isWriterAdd"] . ", isSupport=" . $_SESSION["isSupportAdd"] . ", isAdmin=" . $_SESSION["isAdminAdd"] . ", isSource=" . $_SESSION["isSourceAdd"] . " WHERE peopleID=" . $userID;
    mysql_query($sql);
