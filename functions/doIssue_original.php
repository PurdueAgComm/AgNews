...
{
//echo (" this is ".$_SESSION["issueAdd"]." the submit button");

		
//Validate for an existing issue
//$issue = $_POST["issueAdd"];

// **07-27: Anytime there is htmlspecialchars_decode(stripslashes...), we are asking the text to be rendered to the screen without the slash (\). This only matters upon errors or success messages with this page.
...
// show a success
//-- **07-27: htmlspecialchars(stripslashes) ishows the text without the backslash. Keeps the text together so it doesn't break once the apostrophe is reached  -->
...
$sql = "INSERT INTO tblActivity (newsID, peopleID, strFirstName, strLastName, strActivity) VALUES (NULL, " . $_SESSION["userID"] . ", '" . $_SESSION["firstName"] .  "', '" . $_SESSION["lastName"] . "', 'Deleted the Issue <em>" . $_SESSION["issueEdDel"] . "</em>.');";
mysql_query($sql);
