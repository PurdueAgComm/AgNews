...
<!-- ************good resource for learning checkboxes: http://www.html-form-guide.com/php-form/php-form-checkbox.html   and http://www.hscripts.com/tutorials/html/form-checkbox.php-->

<!-- This is for the PUBLISH date choice -->

  <div style="display:none" id="publish_sub">
        <div class="control-group <?php if($_SESSION['datePublishedBeginError'] == 1) echo 'error'; $_SESSION["publish"]==1;?>">
